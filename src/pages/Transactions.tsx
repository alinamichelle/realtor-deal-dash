...
import { Plus, TrendingUp, TrendingDown, DollarSign, Award, Users } from "lucide-react";
                ...
                <div key={data.month} className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <span className="font-bold">{formatCurrency(data.volume)}</span>
                    </div>
                  </div>
          ...
          <Card className="p-6 bg-gradient-to-br from-primary/5 to-primary/10 border-primary/20">
            <div className="space-y-6">
              <div>
                ...
                <div className="text-4xl font-bold text-primary">$22.8M</div>
              ...
              <div className="pt-6 border-t border-border space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-lg font-bold">$425K</span>
                </div>
                <div className="flex justify-between items-center">
          ...
          <div className="space-y-3">
            {topAgents.map((agent, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  {agent.trend === "up" && <TrendingUp className="h-5 w-5 text-success" />}
                  {agent.trend === "down" && <TrendingDown className="h-5 w-5 text-destructive" />}
                  <div className="text-right">
                    <div className="text-lg font-bold">{formatCurrency(agent.volume)}</div>
